      ...
      {cards.map((card, cardIndex) => {
        ...
        return <div key={cardIndex} data-aos="zoom-out" data-aos-offset="300" data-aos-delay={delay}>
          <div
           ...
           className={`${index === cardIndex && "bg-white shadow-2xl"} w-[350px] h-[350px]  flex flex-col justify-center mx-auto p-[65px] text-center rounded-[12px] cursor-pointer transition-all  items-center`}
          >
            {/* card icon  */}
            <div className='mb-6'>
              <img src={icon} alt="" />
